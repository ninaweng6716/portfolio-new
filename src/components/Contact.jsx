...
export default function Contact({ scrollY }) {
  ...
  const parallaxOffset = sectionRef.current ? (scrollY - sectionRef.current.offsetTop) * 0.05 : 0

  return (
    <section ref={sectionRef} id="contact"
      className="py-[12rem] px-[6vw] grid grid-cols-1 md:grid-cols-2 gap-20 items-center min-h-screen"
