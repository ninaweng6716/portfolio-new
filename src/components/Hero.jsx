...
export default function Hero() {
  ...
  return (
    ...
    >
        ...
        <div className="hero-animate flex items-center gap-3 mb-7" {...delay('0.1s')}>
          ...
          {info.available && (
            <div
              ...
              className="inline-flex items-center gap-2 bg-tq-pale text-tq-dim font-display text-xs font-semibold tracking-[0.1em] uppercase px-3.5 py-1.5 rounded-full"
            >
              <span className="w-1.5 h-1.5 rounded-full bg-tq animate-blink" aria-hidden="true" />
              Available for work
            </div>
          )}
        </div>
        ...
        <div className="hero-animate flex flex-wrap gap-4 items-center" {...delay('0.65s')}>
          ...
          {permission === "prompt" && !loading && (
            <button
              ...
              aria-label="Personalize experience using your location"
      ...
      <div className="hidden md:flex justify-end items-center relative z-1" aria-hidden="true">
            ...
            <div className="relative aspect-square bg-tq-pale overflow-hidden">
              ...
              <div className="absolute bottom-4 left-4 right-4 translate-y-2 opacity-0 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-400">
                <p className="text-white/75 font-display text-sm font-semibold tracking-wide drop-shadow">
                  Also a climber, cat-lover, and mouth-breather
                </p>
              </div>
            </div>
